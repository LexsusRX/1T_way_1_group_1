...
SQLALCHEMY_DATABASE_PASS = os.environ.get('SQLALCHEMY_DATABASE_PASS', default='airflow')
SQLALCHEMY_DATABASE_USER = os.environ.get('SQLALCHEMY_DATABASE_USER', default='airflow')
SQLALCHEMY_DATABASE_NAME = os.environ.get('SQLALCHEMY_DATABASE_NAME', default='airflow')
